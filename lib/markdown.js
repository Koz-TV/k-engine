...
function convertMarkdownToHtml(markdown, metadata, mdDirRel, rootPrefix = '', langOptions = {}) {
    ...
    // Generate original link HTML if provided (e.g., Telegram link)
    const originalLink = metadata.original_link
        ? `<a href="${metadata.original_link}" class="original-link" target="_blank" rel="noopener">Telegram</a>`
        : '';
